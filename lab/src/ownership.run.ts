...
console.log('Y', publicKeyHex.substring(68));
...
// investigate the constraint system generated by verify ownership
console.time('verify ownership (build constraint system)');
let program = await verifyEcdsaOwnershipProgram.analyzeMethods();
console.timeEnd('verify ownership (build constraint system)');
console.log(program.verifySignedHash.summary());
