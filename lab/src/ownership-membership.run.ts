...
console.time('verify ownership + membership (build constraint system)');
let program = await verifyOwnershipMembershipProgram.analyzeMethods();
console.timeEnd('verify ownership + membership (build constraint system)');
console.log(program.verifyOwnershipMembership.summary());

// compile and prove

console.time('verify ownership + membership (compile)');
await verifyOwnershipMembershipProgram.compile();
console.timeEnd('verify ownership + membership (compile)');
